...
8. [What questions do you have for us?](#what-questions-do-you-have-for-us)
9. [How do you deal with a conflict with a coworker?](#how-do-you-deal-with-a-conflict-with-a-coworker)
10. [Where do you see yourself in five years?](#where-do-you-see-yourself-in-five-years)
11. [How would you deal with a difficult customer?](#how-would-you-deal-with-a-difficult-customer)
12. [Tell me about a time when you failed.](#tell-me-about-a-time-when-you-failed)
...
**Situation:** While leading a significant project at BDO Digital for the Cooperative of American Physicians, a top client, we faced the challenge of overhauling their medical insurance underwriting process with AI. The client wanted to use their on-premise member data for the analysis, which conflicted with our recommendation of using a cloud-based SQL server for storage.

**Task:** My task was to find a solution that would allow us to use the client's on-premise data while still providing an online endpoint for the AI model to assess physician information and generate scores.

**Action:** After attempting various technical solutions to connect to the on-premise database from Azure, all of which failed, I escalated the issue to my manager, who then sought help from Microsoft's official dev support team. Concurrently, I thought of an alternative approach. I collaborated with the automation team, who could securely connect to the on-premise database outside of Azure. I transferred the feature engineering and cleaning logic into SQL so it could be incorporated during their query process. The automation team would then ingest the pre-processed data into an Azure SQL database accessible by our model's online endpoint.
